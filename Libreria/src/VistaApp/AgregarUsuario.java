...
public class AgregarUsuario extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        cBoxTipo.setFont(new java.awt.Font("Calibri", 0, 20)); // NOI18N
        cBoxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "admin", "empleado" }));

        lblTipoUsuario.setFont(new java.awt.Font("Arial", 1, 21)); // NOI18N
        lblTipoUsuario.setText("Tipo de usuario:");

        lbResult.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(txtNombreUsuario2, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String cargo = (String)cBoxCargo.getSelectedItem().toString();
        String contra = txtpass.getText();
        String tipo =  (String)cBoxTipo.getSelectedItem().toString();
     
        
        DAO_usuario dauser = new DAO_usuario();
        try
        {             
           lbResult.setText(dauser.insertUser(nom,cargo,contra,tipo));
        }
        catch(Exception ex)
        {
            System.out.println("Error query " + ex.getMessage());
            lbResult.setText("Error " + ex.getMessage());
        }
